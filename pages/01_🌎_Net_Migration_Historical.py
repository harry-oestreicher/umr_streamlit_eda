...
def app():
    ...
    # Setting these now for use later
    frequency = "annual"
    scale = "countries"
    ...
    years_list = inventory_df["TIME_PERIOD"].unique() #2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022]

    with row1_col1:
        selected_year = st.selectbox("**Year**", years_list, 0 )

    with row1_col2:
        indicator = st.selectbox("**Risk Factor Group**", ["DM_", "MG_", "MNCH_", "PT_", "WS_"], 0 )
